  ...
  return (
    <div className='gigs'>
      <div className="container">
        <span className="breadcrumbs">Majdur {category[0]?.toUpperCase() + category.slice(1)}</span>
        <h1>{category[0]?.toUpperCase() + category.slice(1)}</h1>
        <p>Explore the boundaries of art and technology with Majdur's {category} artists</p>
        <div className="menu">
          <div className="left">
            <span>Budget</span>
